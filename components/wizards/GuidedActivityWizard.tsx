...
import { Activity, ActivityStatus, Priority, ActivityType, SecurityDomain, Objective, IsoMeasure } from '../../types';
...
const GuidedActivityWizard: React.FC<GuidedActivityWizardProps> = ({ isOpen, onClose, onSave, onSwitchToManual }) => {
  const { objectives, orientations, resources, securityProcesses, activities } = useData();
